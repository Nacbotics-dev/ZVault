    ...
    <div className="mt-20">
        ...
        <section className="mt-8 grid grid-cols-1 gap-8 md:gap-16 md:grid-cols-2">
            <Card
              ...
              imageSrc="\images\wifi-front-premium.png"
            ...
            <Card
              title="Create Vault"
              imageSrc="\images\locker-front-premium.png"
            ...
            <Card
              title="Now you wait"
              imageSrc="\images\explorer-front-premium.png"
            ...
            <Card
              ...
              imageSrc="\images\key-front-premium.png"
