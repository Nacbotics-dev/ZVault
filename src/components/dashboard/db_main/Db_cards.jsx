...
const Db_cards = () => {
  return (
    <section className="p-7 bg-white rounded-[1.25rem]">
      ...
      <div className="my-6">
        <h3 className="text-[#113E21] text-center text-2xl md:text-[2rem] font-bold">My Next Bull</h3>
      ...
      <button className="bg-[#113E21] text-white font-semibold py-2 px-8 rounded-2xl text-mid-1Head-clamp block mx-auto">Top Up</button>
    </section>
  )
}
